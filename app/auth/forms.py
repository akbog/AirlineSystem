...
class CustomerRegistrationForm(FlaskForm):
    ...
    passport_country = SelectField('Country', choices = [('country','United States'),('country','Italy'),('country','Zimbabwe')]) #Later need to set the Country
...
class simpleSearchForm(FlaskForm):
    departure_airport = SelectField('Departure Airport', choices = [Airport.name])
